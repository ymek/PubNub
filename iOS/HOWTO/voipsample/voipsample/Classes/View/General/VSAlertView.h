...
#import "VSAlertViewDelegate.h"

#pragma mark Types

typedef NS_OPTIONS(NSInteger, VSAlertType) {
...
@interface VSAlertView : VSPopoverView
 ...
 */
@property (nonatomic, pn_desired_weak) id<VSAlertViewDelegate> delegate;
