...
#import "GSAlertViewDelegate.h"

#pragma mark Types

typedef NS_OPTIONS(NSInteger, GSAlertType) {
...
@interface GSAlertView : GSPopoverView
 ...
 */
@property (nonatomic, pn_desired_weak) id<GSAlertViewDelegate> delegate;
...
/**
 ...
 @param animated
 Whether view should be closed with animation or not.
 */
